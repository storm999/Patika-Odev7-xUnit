using AutoMapper;
using BookStorePtk.Applications.GenreOperations.Commands.CreateGenre;
using BookStorePtk.Applications.GenreOperations.Commands.DeleteGenre;
using BookStorePtk.Applications.GenreOperations.Commands.UpdateGenre;
using BookStorePtk.Applications.GenreOperations.Queries.GetGenreDetail;
using BookStorePtk.Applications.GenreOperations.Queries.GetGenres;
